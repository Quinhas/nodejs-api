export interface IResetPasswordEmailTemplateInput {
  name: string;
  resetUrl: string;
}
...
export function resetPasswordEmailTemplate({
  name,
  resetUrl,
}: IResetPasswordEmailTemplateInput): string {
  return `
    <!DOCTYPE html>
    <html lang="en">
    <head>
    ...
    <body role="article" aria-label="Password reset">
      <main class="container">
        ...
        <section class="content">
          ...
          <div class="button-container">
            <a href="${resetUrl}" class="button" role="button" aria-label="Reset password">
              Reset Password
            </a>
          </div>
